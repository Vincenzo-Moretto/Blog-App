// Login.jsx
import { useState, useContext } from "react"; // Aggiunto useContext
import { Link, useNavigate } from "react-router-dom";
import Footer from "../components/footer/Footer";
import axios from "axios";
import { UserContext } from "../context/UserContext"; // Importato UserContext
...
const Login = () => {
  ...
  const { setUser } = useContext(UserContext); // Utilizza setUser dal contesto
  ...
  const getUser = async () => {
    try {
      ...
      setUser(res.data); // Imposta l'utente con i dati ricevuti
