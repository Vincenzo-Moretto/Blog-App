  ...
  const handleCreate = async (e) => {
    ...
    if (file) {
      ...
      try {
        ...
        console.log("Upload response:", imgUpload.data);
        const newFilename = imgUpload.data.filename;
        setImageURL(`${URL}/images/${newFilename}`);
        post.photo = newFilename; // Store new filename if needed for post creation
      } catch (err) {
